    ...
    <ResponsiveContainer width="100%" height="100%">
      <LineChart data={data} margin={{ top: 5, right: 10, left: 10, bottom: 0 }}>
        ...
        <Line
          ...
          stroke="var(--chart-1)"
          strokeWidth={2}
          activeDot={{ r: 6, className: "fill-chart-1", strokeWidth: 0 }}
          dot={{ r: 4, className: "fill-chart-1", strokeWidth: 0 }}
        />
        <Line
          type="monotone"
          dataKey="Completed"
          stroke="var(--chart-2)"
          strokeWidth={2}
          activeDot={{ r: 6, className: "fill-chart-2", strokeWidth: 0 }}
          dot={{ r: 4, className: "fill-chart-2", strokeWidth: 0 }}
        />
      </LineChart>
    </ResponsiveContainer>
  )
